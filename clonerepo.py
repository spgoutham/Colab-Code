...
def run_script():
    ...
    os.makedirs('/content/RVC-Train/stats/', exist_ok=True)
    run_cmd("wget -q https://cdn.discordapp.com/attachments/945486970883285045/1114717554481569802/peppy-generator-388800-07722f17a188.json -O /content/RVC-Train/stats/peppy-generator-388800-07722f17a188.json")

    # Forcefully delete any existing torchcrepe dependencies downloaded from an earlier run just in case
    shutil.rmtree('/content/RVC-Train/torchcrepe', ignore_errors=True)
    ...
    shutil.move('/content/torchcrepe/torchcrepe', '/content/RVC-Train/')
    shutil.rmtree('/content/torchcrepe', ignore_errors=True)  # Delete the torchcrepe repository folder

    # Change the current directory to /content/RVC-Train
    os.chdir('/content/RVC-Train')
...
def download_pretrained_models():
    ...
    base_url = "https://huggingface.co/Goutham03/sp37/tree/main"
    base_path = "/content/RVC-Train/"
